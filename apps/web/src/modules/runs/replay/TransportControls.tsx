    ...
    <button
      ...
      className={cn(
        ...
        active
          ...
          : 'bg-background/50 text-foreground hover:bg-accent ring-white/[0.06]'
      )}
    >
      {children}
    </button>
  ...
  return (
    <div className="flex items-center gap-2" data-testid="transport-controls">
      ...
      <button
        ...
        className="text-muted-foreground hover:text-foreground bg-background/50 focus-visible:ring-ring inline-flex h-10 items-center justify-center rounded-xl px-3 font-mono text-xs tabular-nums ring-1 ring-white/[0.06] transition-[transform,color] duration-150 focus-visible:ring-2 focus-visible:outline-none active:scale-[0.96]"
      >
        {state.speed}x
      </button>
    </div>
